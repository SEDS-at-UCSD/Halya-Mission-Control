...
const Toolbar = ({setFeed, setFeedAmount, values}) => {
  return (
    ...
    <ButtonGroup className="me-2 button-group" aria-label="First group">
        <Button onClick={()=>setFeedAmount(1)}> <img src="/single-square.svg" /> </Button> 
        <Button onClick={()=>setFeedAmount(2)}> <img src="/splitscreen.svg" /> </Button> 
        <Button onClick={()=>setFeedAmount(4)}><FontAwesomeIcon icon={faTableCellsLarge} size="2x"/> </Button> 
